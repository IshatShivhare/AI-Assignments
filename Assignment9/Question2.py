...
def genetic_algorithm():
    ...
    for gen in range(GENERATIONS):
        ...
        for i in range(0, len(population) - 1, 2):  # Ensure we don't go out of range
        ...
        # Handle odd population size by carrying over the last individual
        if len(population) % 2 == 1:
            next_population.append(population[-1])
